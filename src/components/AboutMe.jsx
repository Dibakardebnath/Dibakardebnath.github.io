    ...
    <Box id="about" className="about section" >
      ...
      <Box className='about_right'   >
        ...
        <Box  data-aos="fade-up-right" data-aos-duration="500">
          ...
          <Button  fontSize={"medium"} padding={"7"} size={["sm", "md", "lg", "lg"]} borderRadius="10px"  color={"white"} _hover={{ bg: "gray.900", color: "black"}} bg={"#03c8d7"} onClick={handleReadMoreClick}>{showMoreDetails ? "Read less" : "Read more"}</Button></Box>
        {showMoreDetails && <Box className='more-detail' mt={"30px"} >
       
          <Box>

            <Text mt={"10px"}> <span style={{ color: "#03c8d7", fontWeight: "700" }}> <i class="fa-solid fa-graduation-cap fa-xl"></i></span>  : Techno College Of Engineering Agartala</Text>
            <Divider />
            <Text   mt={"10px"}><span style={{ color: "#03c8d7", fontWeight: "700" }}><i class="fa-solid fa-phone fa-lg"></i> </span> : 8787455034</Text>
            <Divider />
            <Text  mt={"10px"}><span style={{ color: "#03c8d7", fontWeight: "700" }}><i class="fa-solid fa-envelope fa-lg"></i></span>  : ddibakar190@gmail.com</Text>
            <Divider />
            <Text mt={"10px"}> <span style={{ color: "#03c8d7", fontWeight: "700" }}><i class="fa-solid fa-location-dot fa-xl"></i></span>  Agartala,Tripura</Text>
            <Divider />
          </Box>
        </Box>}
